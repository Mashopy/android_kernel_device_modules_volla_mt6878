...
*****************************************************************************/
//drv-add by huangxinglve for TP charger mode 20250721 start
/*
enum _ex_mode {
    MODE_GLOVE = 0,
    MODE_COVER,
...
//drv-add by huangxinglve for TP charger mode 20250721 end
...
int fts_ex_mode_switch(enum _ex_mode mode, int value)//drv-add by huangxinglve for TP charger mode 20250721
{
    int ret = 0;
...
/*drv-add by huangxinglve for glove mode 20250517,add glove mode start*/
static DEVICE_ATTR(state, S_IRUGO | S_IWUSR,
                   fts_glove_mode_show, fts_glove_mode_store);
/*drv-add by huangxinglve for glove mode 20250517,add glove mode end */
...
//drv-add by huangxinglve for TP charger mode 20250721 start
	...
	FTS_DEBUG("ts_data->charger_status = %d;ts_data->charger_mode = %d",ts_data->charger_status,ts_data->charger_mode);
