...
extern bool drv_get_hc5622_doze_state(void);
...
static int fts_ts_resume(struct device *dev)
{
    ...
    FTS_FUNC_ENTER();
    if (!ts_data->suspended || drv_get_hc5622_doze_state()) {//mod by huangxinglve,20250627, mod for double click can not resume in doze
